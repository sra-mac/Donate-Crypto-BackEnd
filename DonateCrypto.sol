...
contract DonateCrypto {
    ...
    function withdraw(uint256 id)public{
        ...
        require(campaign.balance > fee, "This campaign does not have enought balance");

        address payable recepient = payable (campaign.author);
        recepient.call{value: campaign.balance - fee}("");
